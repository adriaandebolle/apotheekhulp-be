    ...
    <div>
      ...
      <section className="bg-primary px-6 py-16">
        <div className="max-w-2xl mx-auto">
          <p className="text-xs font-semibold tracking-widest text-white/70 uppercase mb-2">Wat doen we</p>
          <h1 className="text-3xl font-bold text-white mb-4">Wat we doen</h1>
          <p className="text-white/80 leading-relaxed">
            Flexibele inzet van gekwalificeerde apotheekassistenten — voor apotheken én voor de assistenten zelf.
          </p>
        </div>
      </section>
      ...
      <section className="bg-surface px-6 py-14">
        <div className="max-w-3xl mx-auto">
          <p className="text-xs font-semibold tracking-widest text-primary uppercase mb-1">Onze Troeven</p>
          <h2 className="text-2xl font-bold text-text mb-8">Voor Apotheken</h2>
          <div className="space-y-4">
            {voorApotheken.map(item => (
              <div key={item.title} className="bg-background rounded-xl border border-border p-5">
      ...
      <section className="bg-primary-light px-6 py-14">
        <div className="max-w-3xl mx-auto">
          <p className="text-xs font-semibold tracking-widest text-primary uppercase mb-1">Voordelen</p>
          <h2 className="text-2xl font-bold text-text mb-8">Voor Apotheekassistenten</h2>
          <div className="space-y-3">
            {voorAssistenten.map((voordeel, i) => (
              <div key={i} className="flex gap-3 bg-white rounded-xl border border-border p-4">
                <svg className="w-4 h-4 text-primary mt-0.5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M5 13l4 4L19 7" />
                </svg>
                <p className="text-sm text-text-muted leading-relaxed">{voordeel}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="bg-surface px-6 py-14">
        <div className="max-w-lg mx-auto text-center">
          ...
          <p className="text-text-muted text-sm mb-6">Contacteer ons voor meer informatie over onze diensten.</p>
