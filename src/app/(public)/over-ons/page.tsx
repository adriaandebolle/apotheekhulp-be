      ...
      <section className="bg-primary px-6 py-16">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-white/80 leading-relaxed">
            Apotheekhulp werd opgericht door twee gedreven apothekers die de
            sector van binnenuit kennen.
          </p>
        </div>
      </section>
      ...
      <section className="bg-surface px-6 py-14">
        <div className="max-w-4xl mx-auto">
          <p className="text-text-muted leading-relaxed mb-4">
            ...
            in de apotheekwereld, brengen zij zowel kennis als passie in alles
            wat ze doen.
          </p>
          <p className="text-text-muted leading-relaxed">
            ...
            Dankzij haar ervaring weet ze precies welke vaardigheden essentieel
            zijn voor succes in de apotheekpraktijk.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto grid sm:grid-cols-2 gap-8">
          ...
          <div className="bg-surface rounded-2xl border border-border overflow-hidden">
            ...
            <div className="p-6">
              ...
              <p className="text-sm text-text-muted leading-relaxed mb-4">
                Apotheker met meer dan tien jaar ervaring. Stagebegeleider en
                leerkracht voor apotheekassistenten in het volwassenenonderwijs.
                Ze heeft een scherp oog voor de vaardigheden die essentieel zijn
                in de apotheekpraktijk.
              </p>
              <a
          ...
          <div className="bg-surface rounded-2xl border border-border overflow-hidden">
            ...
            <div className="p-6">
              ...
              <p className="text-sm text-text-muted leading-relaxed mb-4">
                Apotheker met een brede praktijkervaring. Samen met Lieselot
                bouwt ze aan een netwerk van gekwalificeerde assistenten en
                apotheken in België.
              </p>
              <a
      ...
      <section className="bg-surface px-6 py-14">
        <div className="max-w-lg mx-auto text-center">
          ...
          <p className="text-text-muted text-sm mb-6">
            Neem rechtstreeks contact op met Lieselot of Carolien.
          </p>
