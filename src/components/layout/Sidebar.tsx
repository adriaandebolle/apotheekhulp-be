...
const assistentNav: NavItem[] = [
  ...
  { label: "Berichten", href: "/assistent/berichten", icon: icons.tarief },
  {
    label: "Mijn prestaties",
    href: "/assistent/prestaties",
    icon: icons.prestaties,
  },
  { label: "Mijn facturen", href: "/assistent/facturen", icon: icons.facturen },
  {
    label: "Mijn onbeschikbaarheid",
    href: "/assistent/onbeschikbaarheid",
    icon: icons.clock,
  },
  {
    label: "Agenda abonnement",
    href: "/assistent/agenda-abonnement",
    icon: icons.agenda,
  },
  { label: "Mijn profiel", href: "/assistent/profiel", icon: icons.profile },
];
...
const apotheekNav: NavItem[] = [
  ...
  { label: "Berichten", href: "/apotheek/berichten", icon: icons.tarief },
];
